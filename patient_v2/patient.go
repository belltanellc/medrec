...
func (t *PatientChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *PatientChaincode) write(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *PatientChaincode) read(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
